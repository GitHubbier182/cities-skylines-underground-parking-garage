...
namespace UndergroundParkingGarage
{
    ...
    public class UndergroundParkingGarageLoading : LoadingExtensionBase
    {
        private static readonly ReleaseNoticeContent ReleaseNotice = new ReleaseNoticeContent(
            ...
            "v2.4.1",
            "Underground Parking Garage 2.4.1",
            "TM:PE parking compatibility fix",
            string.Empty,
            "UPG",
            new[]
            {
                "Prevents a completed garage arrival from affecting a later TM:PE parking journey at an unrelated destination.",
                "Stops failed parked-car retrieval attempts from entering an invalid-pose retry loop.",
                "Shows incoming reserved spaces separately from cars already parked."
            },
            true,
            string.Empty,
            null,
            new[]
            {
                new ReleaseNoticeVersion("v2.4.0", "13 August 2026, 13:50 BST", new[]
                {
                    "Garage journeys are presented only where the camera can see them, while off-screen cars still complete the same real parking transaction.",
                    "Loaded-city parking discovery now cooperates with Scratchy's shared scan scheduler.",
                    "Under the hood improvements & fixes."
                }, true),
                new ReleaseNoticeVersion("v2.3.0", "8 August 2026, 08:47 BST", new[]
                {
        ...
        public override void OnLevelLoaded(LoadMode mode)
        {
            ...
            UndergroundParkingScanCoordinator.Initialize();
        ...
        public override void OnLevelUnloading()
        {
            ...
            UndergroundParkingScanCoordinator.Shutdown();
    ...
    public class UndergroundParkingGarageThreading : ThreadingExtensionBase
    {
        ...
        public override void OnUpdate(float realTimeDelta, float simulationTimeDelta)
        {
            ...
            UndergroundParkingScanCoordinator.PumpSimulationThread();
